...
class PriceFinderTest {
    ...
    public void yearLongPeriod() {
        FinancialModel model = FinancialModel.PRICE_MODEL_1;
    ...
    public void yearShortPeriod() {
        FinancialModel model = FinancialModel.PRICE_MODEL_3;

        calculator = ConcreteAccountChainFactory.create(model, BigDecimal.valueOf(10000000), 1);
    ...
    public void yearNegativeValue() {
        ...
        calculator = ConcreteAccountChainFactory.create(model, BigDecimal.valueOf(1000000), 5);
    ...
    public void monthCommonCase() {
        ...
        calculator = ConcreteAccountChainFactory.create(model, BigDecimal.valueOf(1000000), 36);
    ...
    public void monthLongPeriod() {
        ...
        calculator = ConcreteAccountChainFactory.create(model, BigDecimal.valueOf(100000), 360);

        ValueFinder finder = new PriceFinder(targetIRR, FINDER_PRECISION, 50,
                Term.MONTH, new StreamNPVCalculator(), new NewtonRaphsonIRRCalculator(), calculator);

        TargetValueAndIRR targetValueAndIRR = finder.find(BigDecimal.valueOf(1000000000000L));
